...
<body>
    ...
    function Status()
    {
        ...
        while ($row = mysqli_fetch_array($sqlresult)) {
            ...
            if ($row[8] == 'COMPLETED') {
                echo '<p>YOU COMPLETED A TRANSACTION!</p>
                <br>
<div class="col">
<center>
                    <h1><span id="words">Hi ' . $row[1] . ', Your Transaction is Finally Completed!</span></h1>
                    <br>
...
<script type="text/javascript">
    (function() {
        var words = ["Thank you for trusting magnifiscent perfume!", "Thank you", "Thank you for trusting us!."],
            i = 0;
